...
export const getMessages = (messagesPerUser: any) => {
  let messages: any = {};
  _.forEach(users, (user: any) => {
    messages[user.user_id] = {
      ..._.mapKeys(generateMsgs(messagesPerUser), "num"),
    };
  });
  return messages;
};
 ...
 */
function generateUsers(numberOfUsers: any) {
  return Array.from({ length: numberOfUsers }, () => generateUser());
}

function generateMsgs(numberOfMsgs: any) {
